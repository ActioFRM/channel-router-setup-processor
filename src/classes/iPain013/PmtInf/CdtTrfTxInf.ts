...
class Doc {
  PyeeRcvAmt: PyeeRcvAmt = new PyeeRcvAmt();
  PyeeFinSvcsPrvdrFee: PyeeFinSvcsPrvdrFee = new PyeeFinSvcsPrvdrFee();
  PyeeFinSvcsPrvdrComssn: PyeeFinSvcsPrvdrComssn = new PyeeFinSvcsPrvdrComssn();
}
